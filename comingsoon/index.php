...
<head>
	...
	<title>PixonPlay - Coming Soon</title>
    ...
    <!-- Favicons -->
    <link href="http://localhost/a/images/favi.ico" rel="icon" type="image/x-icon" />
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="http://localhost/a/index.php" title="Px - Coming Soon">
            	<img src="http://localhost/a/images/logo.png" alt="Px - Coming Soon">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
